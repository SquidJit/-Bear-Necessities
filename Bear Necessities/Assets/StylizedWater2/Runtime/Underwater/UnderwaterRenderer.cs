...
namespace StylizedWater2
{
    ...
    public class UnderwaterRenderer : MonoBehaviour
    {
        ...
        public const string MinBaseVersion = "1.3.0";
        ...
        private static readonly int _UnderwaterSurfaceSmoothness = Shader.PropertyToID("_UnderwaterSurfaceSmoothness");
        private static readonly int _UnderwaterRefractionOffset = Shader.PropertyToID("_UnderwaterRefractionOffset");
